...
Horizon is an open-source project maintained in spare time. If you'd like to support its ongoing development, feel free to [open an issue](https://github.com/Thysrael/Horizon/issues/new) or [email me](mailto:thysrael@163.com).
